...
public class DistrictSpecifications {
    ...
    public static Specification<DistrictEntity> byCriteria(DistrictSearchCriteria criteria) {
        return (root, query, cb) -> {
            ...
            if (StringUtils.hasText(criteria.getLocalityId())) {
                predicates.add(cb.equal(root.get("locality").get("id"), criteria.getLocalityId()));
            }
